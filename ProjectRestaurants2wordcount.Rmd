...
#wordcloud
tidy_A_rest_reviews$words <- paste(tidy_A_rest_reviews$one, tidy_A_rest_reviews$two, sep= " ")
tidy_A_rest_reviews %>%
  with(wordcloud(words, n, min.freq = 8, random.order = FALSE, scale=c(2.5, 0.3),
...
#wordcloud
tidy_B_rest_reviews$words <- paste(tidy_B_rest_reviews$one, tidy_B_rest_reviews$two, sep= " ")
tidy_B_rest_reviews %>%
  with(wordcloud(words, n, min.freq = 15, random.order = FALSE, scale=c(2.5, 0.3),
                 colors = brewer.pal(8,"Paired")))
...
#wordcloud
tidy_L_rest_reviews$words <- paste(tidy_L_rest_reviews$one, tidy_L_rest_reviews$two, sep= " ")
tidy_L_rest_reviews %>%
  with(wordcloud(words, n, min.freq = 30, random.order = FALSE, scale=c(2.5, 0.3),
                 colors = brewer.pal(8,"Paired")))
...
#wordcloud
tidy_M_rest_reviews$words <- paste(tidy_M_rest_reviews$one, tidy_M_rest_reviews$two, sep= " ")
tidy_M_rest_reviews %>%
  with(wordcloud(words, n, min.freq = 12, random.order = FALSE, scale=c(2.5, 0.3),
                 colors = brewer.pal(8,"Paired")))
...
#wordcloud
tidy_P_rest_reviews$words <- paste(tidy_P_rest_reviews$one, tidy_P_rest_reviews$two, sep= " ")
tidy_P_rest_reviews %>%
  with(wordcloud(words, n, min.freq = 25, random.order = FALSE, scale=c(2.5, 0.3),
                 colors = brewer.pal(8,"Paired")))
...
#wordcloud
tidy_V_rest_reviews$words <- paste(tidy_V_rest_reviews$one, tidy_V_rest_reviews$two, sep= " ")
tidy_V_rest_reviews %>%
  with(wordcloud(words, n, min.freq = 8, random.order = FALSE, scale=c(2.5, 0.3),
                 colors = brewer.pal(8,"Paired")))
