...
tidy_A_rest_reviews <- A_rest_reviews %>%
  select(X, Reviews) %>%
  unnest_tokens(ngram, Reviews, token = "ngrams", n=3) %>%
...
tidy_A_rest_reviews$three <- gsub("\\s+","",tidy_A_rest_reviews$three)
...
tidy_A_rest_reviews <-tidy_A_rest_reviews[-grep("\\b\\d+\\b", tidy_A_rest_reviews$three),]
...
A_rest_top20$three <- as.factor(A_rest_top20$three)
A_rest_top20$words <- paste(A_rest_top20$one, A_rest_top20$two, 
                            A_rest_top20$three, sep=" ")
...
ggplot(A_rest_top20, aes(x=reorder(words, n), y=n, fill=words))+
  ...
  ylab("Number of Times Ngrams of 3 Appear in Amsterdam Restaurant Reviews")+
  xlab("")+
...
tidy_B_rest_reviews$three <- gsub("\\s+","",tidy_B_rest_reviews$three)
...
tidy_B_rest_reviews <-tidy_B_rest_reviews[-grep("\\b\\d+\\b", tidy_B_rest_reviews$three),]
...
B_rest_top20$three <- as.factor(B_rest_top20$three)
B_rest_top20$words <- paste(B_rest_top20$one, B_rest_top20$two, B_rest_top20$three, sep=" ")
...
tidy_L_rest_reviews$three <- gsub("\\s+","",tidy_L_rest_reviews$three)
...
tidy_L_rest_reviews <-tidy_L_rest_reviews[-grep("\\b\\d+\\b", tidy_L_rest_reviews$three),]
...
L_rest_top20$three <- as.factor(L_rest_top20$three)
L_rest_top20$words <- paste(L_rest_top20$one, L_rest_top20$two, 
                            L_rest_top20$three, sep=" ")
...
tidy_M_rest_reviews$three <- gsub("\\s+","",tidy_M_rest_reviews$three)
...
tidy_M_rest_reviews <-tidy_M_rest_reviews[-grep("\\b\\d+\\b", tidy_M_rest_reviews$three),]
...
M_rest_top20$three <- as.factor(M_rest_top20$three)
M_rest_top20$words <- paste(M_rest_top20$one, M_rest_top20$two, 
                            M_rest_top20$three, sep=" ")
...
tidy_P_rest_reviews$three <- gsub("\\s+","",tidy_P_rest_reviews$three)
...
tidy_P_rest_reviews <-tidy_P_rest_reviews[-grep("\\b\\d+\\b", tidy_P_rest_reviews$three),]
...
P_rest_top20$three <- as.factor(P_rest_top20$three)
P_rest_top20$words <- paste(P_rest_top20$one, P_rest_top20$two, 
                            P_rest_top20$three, sep=" ")
...
tidy_V_rest_reviews$three <- gsub("\\s+","",tidy_V_rest_reviews$three)
...
tidy_V_rest_reviews <-tidy_V_rest_reviews[-grep("\\b\\d+\\b", tidy_V_rest_reviews$three),]
...
V_rest_top20$three <- as.factor(V_rest_top20$three)
V_rest_top20$words <- paste(V_rest_top20$one, V_rest_top20$two, 
                            V_rest_top20$three, sep=" ")
