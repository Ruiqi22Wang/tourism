...
tidy_A_hotel_neg_reviews <- A_hotel_reviews %>%
  ...
  unnest_tokens(ngram, Negative_Review, token = "ngrams", n=2)
...
tidy_A_hotel_pos_reviews <- A_hotel_reviews %>%
  ...
  unnest_tokens(ngram, Positive_Review, token = "ngrams", n=2)
...
#wordcloud
tidy_A_hotel_reviews$words <- paste(tidy_A_hotel_reviews$one, tidy_A_hotel_reviews$two, sep= " ")
tidy_A_hotel_reviews %>%
  with(wordcloud(words, n, min.freq = 300, random.order = FALSE, scale=c(2.5, 0.3),
...
A_hotel_top20$words <- paste(A_hotel_top20$one, A_hotel_top20$two, sep=" ")
...
#wordcloud
tidy_B_hotel_reviews$words <- paste(tidy_B_hotel_reviews$one, tidy_B_hotel_reviews$two, sep= " ")
...
B_hotel_top20$words <- paste(B_hotel_top20$one, B_hotel_top20$two, sep=" ")
...
#wordcloud
tidy_L_hotel_reviews$words <- paste(tidy_L_hotel_reviews$one, tidy_L_hotel_reviews$two, sep= " ")
tidy_L_hotel_reviews %>%
  with(wordcloud(words, n, min.freq = 800, random.order = FALSE, scale=c(2.5, 0.3),
                 colors = brewer.pal(8,"Dark2")))
...
L_hotel_top20$words <- paste(L_hotel_top20$one, L_hotel_top20$two, sep=" ")
...
#wordcloud
tidy_M_hotel_reviews$words <- paste(tidy_M_hotel_reviews$one, tidy_M_hotel_reviews$two, sep= " ")
tidy_M_hotel_reviews %>%
  with(wordcloud(words, n, min.freq = 250, random.order = FALSE, scale=c(2.5, 0.3),
                 colors = brewer.pal(8,"Dark2")))
...
M_hotel_top20$words <- paste(M_hotel_top20$one, M_hotel_top20$two, sep=" ")
...
#wordcloud
tidy_P_hotel_reviews$words <- paste(tidy_P_hotel_reviews$one, tidy_P_hotel_reviews$two, sep= " ")
...
P_hotel_top20$words <- paste(P_hotel_top20$one, P_hotel_top20$two, sep=" ")
...
#wordcloud
tidy_V_hotel_reviews$words <- paste(tidy_V_hotel_reviews$one, tidy_V_hotel_reviews$two, sep= " ")
...
V_hotel_top20$words <- paste(V_hotel_top20$one, V_hotel_top20$two, sep=" ")
